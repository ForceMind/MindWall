...
export declare class SandboxController {
    ...
    getMatchMessages(matchId: string, userId?: string, limit?: string): Promise<{
        match_id: string;
        total: number;
        messages: {
            message_id: string;
    ...
    getWallState(matchId: string, userId?: string): Promise<import("./sandbox.service").WallDecisionResult>;
    submitWallDecision(matchId: string, body: {
        user_id?: string;
        accept?: boolean;
