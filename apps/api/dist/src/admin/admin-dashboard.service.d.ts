...
export declare class AdminDashboardService {
    ...
    constructor(prisma: PrismaService, aiUsageService: AiUsageService, promptTemplateService: PromptTemplateService, serverLogService: ServerLogService);
    getOverview(): Promise<{
    ...
    listOnlineUsers(minutes: number): Promise<{
    ...
    getAiRecords(page: number, limit: number): Promise<{
        page: number;
        limit: number;
        total: number;
        records: {
    ...
    getServerLogs(lines: number): Promise<{
        file: string;
        available: boolean;
        total_lines: number;
        lines: string[];
