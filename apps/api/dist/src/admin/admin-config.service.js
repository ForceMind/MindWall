...
let AdminConfigService = AdminConfigService_1 = class AdminConfigService {
    ...
    async getAiConfig() {
        ...
        const runtimeHasEmbeddingApiKey = Object.prototype.hasOwnProperty.call(runtime, 'openai_embedding_api_key');
        const runtimeEmbeddingApiKey = typeof runtime.openai_embedding_api_key === 'string'
            ? runtime.openai_embedding_api_key.trim()
            : '';
        const envEmbeddingApiKey = process.env.OPENAI_EMBEDDING_API_KEY?.trim() || '';
        const runtimeHasEmbeddingModel = Object.prototype.hasOwnProperty.call(runtime, 'openai_embedding_model');
        const runtimeEmbeddingModel = typeof runtime.openai_embedding_model === 'string'
            ...
            source: {
                ...
                openai_api_key: runtime.openai_api_key
                    ...
                    : process.env.OPENAI_API_KEY
                        ? 'env'
                        : 'unset',
                openai_embedding_api_key: Object.prototype.hasOwnProperty.call(runtime, 'openai_embedding_api_key')
                    ? 'runtime-config'
                ...
                openai_model: runtime.openai_model
                    ...
                    : process.env.OPENAI_MODEL
                        ? 'env'
                        : 'default',
                openai_embedding_model: Object.prototype.hasOwnProperty.call(runtime, 'openai_embedding_model')
                    ? 'runtime-config'
    ...
    async testAiConnectivity(overrides) {
        ...
        const ai = {
            ...
            openaiEmbeddingApiKey: typeof overrides?.openai_embedding_api_key === 'string'
    ...
    getEmbeddingsUrl(baseUrl) {
        return this.resolveEndpoint(baseUrl, 'embedding');
    }
    resolveEndpoint(baseUrl, type) {
